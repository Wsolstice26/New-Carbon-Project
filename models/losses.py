...
class HybridLoss(nn.Module):
    def __init__(self, alpha=1.0, beta=0.1, gamma=0.05, delta=1.0):
    ...
    def forward(self, pred, target, input_main):
        ...
        return self.alpha * l_pix + self.beta * l_ssim + self.gamma * l_edge + self.delta * l_cons